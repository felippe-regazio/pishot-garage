	...
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="about-theme">
			<div class="theme-description">
				...
				?></p>
				<p class="actions">
					<a href="<?php echo esc_url( AUTOMOBILE_HUB_FREE_THEME_URL ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'automobile-hub' ); ?></a>

					<a href="<?php echo esc_url( AUTOMOBILE_HUB_DEMO_THEME_URL ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View Demo', 'automobile-hub' ); ?></a>

					<a href="<?php echo esc_url( AUTOMOBILE_HUB_DOCS_THEME_URL ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Instructions', 'automobile-hub' ); ?></a>

					<a href="<?php echo esc_url( AUTOMOBILE_HUB_RATE_THEME_URL ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Rate this theme', 'automobile-hub' ); ?></a>

					<a href="<?php echo esc_url( AUTOMOBILE_HUB_PRO_THEME_URL ); ?>" class="green button button-secondary" target="_blank"><?php esc_html_e( 'Upgrade to pro', 'automobile-hub' ); ?></a>
				</p>
			</div>
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( AUTOMOBILE_HUB_SUPPORT_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Support Forum', 'automobile-hub' ); ?></a></p>
			</div>
